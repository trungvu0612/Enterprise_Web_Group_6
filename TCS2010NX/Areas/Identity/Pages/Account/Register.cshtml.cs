...
namespace TCS2010NX.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CUser { UserName = Input.Email, Email = Input.Email, DepartmentId = Input.DepartmentId, Number = Input.Number, FirstName = Input.FirstName, LastName = Input.LastName };
